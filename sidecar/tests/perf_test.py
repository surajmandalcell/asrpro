...
class PerformanceTester:
    ...
    async def benchmark_model(
        ...
        try:
            ...
            # Actual backend chosen by loader; may differ from requested
            current_device = manager.get_current_backend()
                ...
                if audio_type == "real_audio" and "file_path" in test_case:
                    ...
                    try:
                        with open(temp_file, "rb") as audio_file:
                            # Use the standard transcription method - backend is handled internally
