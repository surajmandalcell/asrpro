...
class DeviceDetector:
    ...
    def _check_cuda(self):
        ...
        try:
            ...
            if torch.cuda.is_available():
                ...
                logger.info(f"CUDA is available: {self.device_info['cuda_device_name']}")
        except ImportError:
    ...
    def _determine_best_device(self):
        ...
        if self.device_info["cuda_available"]:
            ...
            self.device_info["device_name"] = self.device_info.get("cuda_device_name", "CUDA")
        ...
        logger.info(f"Selected device: {self.device_info['device_name']} ({self.device_info['device']})")
