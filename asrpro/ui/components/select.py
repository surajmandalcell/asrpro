...
from PySide6.QtWidgets import QComboBox, QStyledItemDelegate, QStyleOptionComboBox, QStyle
    ...
    def _apply_styles(self):
        ...
        self.setStyleSheet(f"""
            ...
            MacSelect::down-arrow {{
                ...
                border-top: 6px solid {DarkTheme.SECONDARY_TEXT.name()};
                margin-top: 2px;
            }}
            
            MacSelect::down-arrow:hover {{
                border-top-color: {DarkTheme.PRIMARY_TEXT.name()};
            }}
            ...
            MacSelect QAbstractItemView::item:hover {{
                background-color: {DarkTheme.HOVER_BG.name()};
            }}
        """)
