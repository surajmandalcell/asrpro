...
class NavigationItem(QWidget):
    ...
    def _apply_styles(self):
        """Apply base styles."""
        self.setFixedHeight(Dimensions.NAV_ITEM_PADDING_V * 2 + Dimensions.NAV_ITEM_ICON_SIZE + 4)
...
class LogoSection(QWidget):
    ...
    def _setup_ui(self):
        ...
        # Load microphone icon with secondary text color
...
class Sidebar(QWidget):
    ...
    def _setup_ui(self):
        ...
        nav_layout.setContentsMargins(0, Dimensions.SIDEBAR_PADDING_V, 0, Dimensions.SIDEBAR_PADDING_V)
    ...
    def paintEvent(self, event):
        """Custom paint event for consistent background."""
